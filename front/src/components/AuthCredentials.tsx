...
export function AuthCredentials() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isSignUp) {
      ...
      alert(`Account created successfully for ${email}! (Mock Registration)`)
      navigate('/dashboard')
    } else {
      console.log('Signing in user:', { email, password })
      alert(`Successfully signed in as ${email}! (Mock Login)`)
      navigate('/dashboard')
    }
  }
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div className="input-group">
            ...
            <div className="input-wrapper">
              ...
              >
                {showPassword ? (
                  <svg style={styles.eyeIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <p style={styles.footerText}>
          {isSignUp ? (
            <>
              ...
              <Link to="/signin" className="auth-link" style={{ fontWeight: 600 }}>
                Sign in
              </Link>
            </>
          ) : (
